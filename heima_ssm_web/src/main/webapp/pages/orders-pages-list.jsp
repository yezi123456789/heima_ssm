                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
								...
								<%--<c:forEach begin="1" end="5" var="pageNum1">--%>
									<%--<option >${pageNum1}</option>--%>
								<%--</c:forEach>--%>



								<c:forEach begin="1" end="5" step="1" var="pageNum1">
									<c:if test="${pageInfo.pageSize == pageNum1}">
										<option selected>${pageNum1}</option>
									</c:if>
									<c:if test="${pageInfo.pageSize != pageNum1}">
										<option>${pageNum1}</option>
									</c:if>
